  ...
  return (
    <main>
      ...
      <article className="max-w-3xl mx-auto p-5">
        <h1 className="text-black text-3xl mt-10 mb-3">{post.title}</h1>
        ...
        <div className="flex items-center space-x-2">
          <img
            ...
            alt=""
          />
          <p className="font-extralight text-black text-sm">
            Blog post by{" "}
      ...
      >
        ...
        <h4 className="text-3xl text-black font-bold">Leave a comment below</h4>
        ...
        <label className="block mb-5">
          ...
          <input
            ...
            w-full ring-green-500 outline-none focus:ring"
            placeholder="Name"
            type="text"
          />
        </label>
        ...
        <label className="block mb-5">
          ...
          <textarea
            ...
            className="text-black shadow border rounded py-2 px-3 form-textarea mt-1 block 
            w-full ring-green-500 outline-none focus:ring"
            placeholder="comment"
            rows={8}
          />
        ...
        <div className="flex flex-col p-5">
          ...
          {errors.email && (
            <span className="text-red-500"> -The emailfield is required</span>
          )}
          {errors.comment && (
